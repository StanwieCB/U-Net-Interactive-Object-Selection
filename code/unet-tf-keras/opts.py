...
parser.add_argument('--image_dir', type=str, default='', help='which picture to be processed')
parser.add_argument('--image_ext', type=str, default='', help='which picture to be processed')
